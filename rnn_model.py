...
from SNS_server.data_acquisition import get_historical_data, get_updated_stock_data, process_stock_data, save_locally
import os
import pickle
...
def train_model(ticker):
    ...
    for i in range(ROLLOING_WINDOW,training_scaled.shape[0]):
